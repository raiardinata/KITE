<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="Master_UserApp.aspx.cs" Inherits="KITE.Pages.ContentPages.Master_UserApp" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- Region Item ID -->
    <div class="modal fade" id="InsertUpdateUser" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Form Insert / Update User</h4>
                </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            ...
                            <fieldset class="fielset">
                                ...
                                <div id="Div11" class="gridTitle" runat="server">
                                    <table width="99%">
                                    </table>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group" id="pass1" runat="server">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPassword" ValidationGroup="RegisterCheck"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="form-group" id="pass2" runat="server">
                                        ...
                                        <asp:CompareValidator ID="cmpvldPassword" runat="server" ControlToCompare="txtPassword2"
                ...
                <div class="modal-footer">
                    <asp:Button runat="server" class="btn btn-primary" ID="btnSubmit" Text="Submit" ValidationGroup="RegisterCheck" CausesValidation="true" OnClick="btnSubmit_Click" />
            ...
            <div id="inputarea">
                ...
                <div id="Div3" runat="server" class="rounded-corners">
                    <asp:Panel ID="Panel2" runat="Server" ScrollBars="Horizontal">
                        <asp:GridView ID="grid" runat="server" AutoGenerateColumns="false" CssClass="GridView" CellPadding="0" CellSpacing="0" AllowSorting="true" OnRowCommand="grid_RowCommand" OnRowUpdating="grid_RowUpdating" OnRowDataBound="grid_RowDataBound" OnRowEditing="grid_RowEditing" OnRowDeleting="grid_RowDeleting">
