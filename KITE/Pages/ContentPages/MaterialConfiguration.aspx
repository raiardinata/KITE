<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="MaterialConfiguration.aspx.cs" Inherits="KITE.Pages.ContentPages.MaterialConfiguration" %>
        ...
        <ContentTemplate>
            ...
            <div id="inputarea">
                <div id="header1" style="padding-left: 10px; min-width: 750px; vertical-align: top; padding-top: 5px; border-bottom: solid 5px #7bfdf6; padding-bottom: 10px; margin-bottom: 10px">
                    <asp:Label ID="lbl1" runat="server" Text="Material Configuration" Font-Size="X-Large" />
                    <br />
                    <asp:Label ID="lbl2" runat="server" Text="Master > Material Configuration" />
                </div>
                <div id="gridTitle" class="gridTitle" runat="server">
                        ...
                        <tr>
                            ...
                            <td class="auto-style6">
                                <asp:Panel ID="searchBox" CssClass="searchBox" runat="server" >
                                    <asp:DropDownList ID="ddlSearchCriteria" runat="server" Height="21px" Width="154px" OnSelectedIndexChanged="ddlSearchCriteria_SelectedIndexChanged1" AutoPostBack="true">
                    ...
                    <table>
                        <tr>
                            <td class="auto-style4">
                                <asp:Label ID="Label10" runat="server" Text="Material" Font-Bold="True" Font-Size="11pt"></asp:Label>
                            </td>
                            <td>
                                <asp:ListBox ID="lbMaterial" runat="server" Height="147px" SelectionMode="Multiple" Width="200px" >
                            ...
                            <td>
                                <asp:ListBox ID="lbMaterial2" runat="server" Height="147px" SelectionMode="Multiple" Width="200">
