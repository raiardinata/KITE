<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="Input_KITED.aspx.cs" Inherits="KITE.Pages.ContentPages.Input_KITED" %>
        ...
        <ContentTemplate>
            ...
            <div id="inputarea">
                <div id="header1" style="padding-left: 10px; min-width: 750px; vertical-align: top; padding-top: 5px; border-bottom: solid 5px #7bfdf6; padding-bottom: 10px; margin-bottom: 10px">
                    <asp:Label ID="lbl1" runat="server" Text="KITE D. Laporan Pemasukan Hasil Produksi" Font-Size="X-Large" />
                    <br />
                    <asp:Label ID="lbl2" runat="server" Text="Report > D. Laporan Pemasukan Hasil Produksi" />
                </div>
