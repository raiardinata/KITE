<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="Output_KITEB.aspx.cs" Inherits="KITE.Pages.ContentPages.Output_KITEB" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div class="container-fluid bg-1 text-left">
                <h1 class="margin">KITE B</h1>
                <h2 class="margin">Laporan Pemakaian Bahan Baku</h2>
            </div>
                            ...
                            <div id="DivGrid" runat="server" class="rounded-corners">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="GridView" AllowSorting="true" OnSorting="GridView1_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Digunakan" SortExpression="Quota" HeaderStyle-CssClass="HeaderText" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Subkontrak" SortExpression="Status" HeaderStyle-CssClass="HeaderText">
                                            <ItemTemplate>
