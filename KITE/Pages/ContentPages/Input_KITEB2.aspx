<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="Input_KITEB2.aspx.cs" Inherits="KITE.Pages.ContentPages.Input_KITEB2" %>
        ...
        <ContentTemplate>
            ...
            <div id="inputarea">
                ...
                <asp:Panel ID="Panel2" runat="Server" ScrollBars="Horizontal">
                        <asp:GridView ID="grid" runat="server" AutoGenerateColumns="false" CssClass="GridView" CellPadding="0" CellSpacing="0" AllowSorting="true" OnRowCommand="grid_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="No" ItemStyle-Width="20%" Visible="TRUE">
                                    <ItemTemplate>
                                        <asp:Label ID="No" runat="server" Text='<%# Eval("Nomor") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Nomor" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:Label ID="Nomor" runat="server" Text='<%# Eval("Nomor") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Tanggal" ItemStyle-Width="15%">
                                    <ItemTemplate>
                                        <asp:Label ID="Tanggal" runat="server" Text='<%# Eval("Tanggal") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Kode Barang" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:Label ID="Kode_barang" runat="server" Text='<%# Eval("Kode_barang") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Nama Barang" ItemStyle-Width="15%">
                                    <ItemTemplate>
                                        <asp:Label ID="Nama_Barang" runat="server" Text='<%# Eval("Nama_Barang") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Satuan" ItemStyle-Width="15%">
                                     <ItemTemplate>
                                        <asp:Label ID="Satuan" runat="server" Text='<%# Eval("Satuan") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Digunakan" ItemStyle-Width="15%">
                                    <ItemTemplate>
                                        <asp:Label ID="Digunakan" runat="server" Text='<%# Eval("Digunakan") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Disubkontrakkan" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:Label ID="Disubkontrakkan" runat="server" Text='<%# Eval("Disubkontrakkan") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="SubKontrak" ItemStyle-Width="15%">
                                    <ItemTemplate>
                                        <asp:Label ID="Subkontrak" runat="server" Text='<%# Eval("Subkontrak") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="User ip" ItemStyle-Width="15%">
                                     <ItemTemplate>
                                        <asp:Label ID="User_ip" runat="server" Text='<%# Eval("User_ip") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
             ...
             <div id="dataPager" runat="server" class="pagerstyle">
                    ...
                    <div id="paging" runat="server">
                        ...
                        &nbsp;
                        <asp:Button ID="btnPrev" runat="server" Text="<" ToolTip="Previous Page" OnClick="btnPrev_Click" />
