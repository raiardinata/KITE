<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="ExportSalesUpload.aspx.cs" Inherits="KITE.Pages.ContentPages.ExportSalesUpload" %>
        ...
        <table>
            <tr>
                <td style="padding: 5px; max-width: 240px;">
                    <span style="position: relative; top: 10px; left: 3px; background-color: white; z-index: 1; font-weight: bold; padding: 0px 3px 0px 3px;">Export Sales Check Data</span>
                ...
                <td style="padding: 5px; vertical-align: top; width: 100%;">
                    <span style="position: relative; top: 10px; left: 3px; background-color: white; z-index: 1; font-weight: bold; padding: 0px 3px 0px 3px;">Export Sales Upload</span>
                    ...
                    <asp:Panel ID="CsvPanel" runat="Server" ScrollBars="Horizontal">
                        <asp:GridView class="GridView" ID="CsvDataGridView" runat="server" AutoGenerateColumns="False" AllowPaging="true" OnRowDataBound="CsvDataGridView_RowDataBound" OnPageIndexChanging="CsvDataGridView_PageIndexChanging">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Vendor" SortExpression="Vendor" HeaderText="Vendor" />
                                <asp:BoundField DataField="Vendor_Name" SortExpression="Vendor_Name" HeaderText="Vendor Name" />
                                ...
                                <asp:BoundField DataField="SaType" SortExpression="SaType" HeaderText="SaType" />
                                <asp:BoundField DataField="Sold_to_party" SortExpression="Sold_to_party" HeaderText="Sold_to_party" />
