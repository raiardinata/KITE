<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="LogActivities.aspx.cs" Inherits="KITE.Pages.ContentPages.LogActivities" %>
        ...
        <ContentTemplate>
            ...
            <div id="inputarea">
                <div id="header1" style="padding-left: 10px; min-width: 750px; vertical-align: top; padding-top: 5px; border-bottom: solid 5px #7bfdf6; padding-bottom: 10px; margin-bottom: 10px">
                    <asp:Label ID="lbl1" runat="server" Text="Log Activities" Font-Size="X-Large" />
                    <br />
                    <asp:Label ID="lbl2" runat="server" Text="Log Activities" />
                </div>
                                ...
                                <div style="width:100%">
                                    ...
                                    <table style="width:50%">  
                                        <tr>
                                            ...
                                            <td style="width:39%">
                                                <asp:DropDownList ID="ddlUser" AutoPostBack="false" CssClass="norm text string" runat="server" CausesValidation="false" Width="100" >
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
                                    <table style="width:50%">  
                                        <tr>
                                            <td style="width:65%">
                                                ...
                                                <%--<asp:Label ID="Label2" runat="server" Text="Plant : " Style="text-align: left" />--%>
                                            </td>

                                            <td style="width:39%">
                                                <asp:DropDownList ID="ddlStatus" AutoPostBack="false" CssClass="norm text string" runat="server" CausesValidation="false" Width="100">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
