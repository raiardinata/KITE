...
namespace KITE.Pages.ContentPages
{
    public partial class GRFinishGoodsUpload : System.Web.UI.Page
    {
        ...
        protected void btnView(object sender, EventArgs e)
        {
            ...
            CsvDataList = new GRFinishGoodsFunctionModel().GRFinishGoodsDatatableToList(dataTableRes.Item1);
        ...
        public void btnDownloadToCsv(object sender, EventArgs e)
        {
            ...
            string fileName = $"{DateTime.Now:yyyyMMdd}KITE_GRFinishGoods.csv";
